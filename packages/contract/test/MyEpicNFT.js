...
describe("MyEpicNFT", function() {
  ...
  async function deployMyEpicNFTFixture() {
    ...
    const firstWords = ["JAPAN", "U.S", "CHINA", "THAI", "KOREA", "GERMANY"];
    const secondWords = ["JAN", "FEB", "MAR", "APL", "MAY", "JUNE"];
    const thirdWords = ["DOG", "CAT", "BIRD", "COW", "PIG", "HUMAN"];
